    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Family-Photo</h3>
                    <p class="text-subtitle text-muted">
                        Silahkan edit foto yang ada pada halaman Family-Photo.
                        Gunakan editor ini untuk melakukan edit pada halaman Family-Photo yang telah disediakan.
                    </p>
                </div>
        ...
        <section class="section">
            <div class="row">
                <div class="col-12">
                    <div class="card-body">
                        <form action="{{ route('editFamilyPhoto', $familyphotos->id) }}" method="POST">
                            @csrf
                            @method('PUT')
